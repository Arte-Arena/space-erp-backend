...
var allowedKeys = []string{ENV, PORT, MONGODB_URI, MYSQL_URI, LARAVEL_API_URL, SPACE_DESK_WEBHOOK_X_API_KEY, SPACE_DESK_API_KEY, FRENET_API_KEY, REDIS_ADDR, REDIS_PASS, REDIS_DB}
